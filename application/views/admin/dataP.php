      ...
      <ul class="navbar-nav w-100 d-flex justify-content-center">
          ...
          <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                        <li><a class="dropdown-item active" href="#">Data Pasien</a></li>
  ...
  <div class="container my-5">
    ...
    <thead class="table-primary" style="background-color: #00705a; color: #ffffff; border-top-left-radius: 10px; border-top-right-radius: 10px;">
        <tr>
            ...
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">Tanggal Lahir</th>
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">Jenis Kelamin</th>
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">Alamat</th>
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">Golongan Darah</th>
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">No. Telepon</th>
            <th style="border-color: #00705a; text-align: center; font-weight: bold;">Riwayat Penyakit</th>
